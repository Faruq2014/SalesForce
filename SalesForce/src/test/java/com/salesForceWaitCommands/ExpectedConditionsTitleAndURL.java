...
public class ExpectedConditionsTitleAndURL {
	...
	public void titleTest() {
		...
		Boolean titleIs = wait.until(ExpectedConditions.titleIs("Salesforce: We Bring Companies and Customers Together"));
	  ...
	  String  expectedHomeTitle = "Salesforce: We Bring Companies and Customers Together"; 
	    boolean isTitleFromSource = wait.until 
	                                (ExpectedConditions .
	                                   titleIs(expectedHomeTitle)); 
	    assertTrue(isTitleFromSource == true); 
	...
	public void URLtest() {
		 ...
		 //check if the home url is correct .
		  ...
		  String  expectedHomeURL = "https://www.salesforce.com/"; 
		    boolean isURLeFromSource = wait.until 
		                                (ExpectedConditions .
		                                		urlToBe(expectedHomeURL)); 
		    assertTrue(isURLeFromSource == true); 
