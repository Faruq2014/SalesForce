	...
	public class RegularCSS {
		...
		public void endsWithAttributeTest() {
			// CSS formula = [attribute$=’value’] $ mean ends with (do not use it, really
			// does not work,work sometime.)
			// driver.findElement(By.cssSelector("[class$='input wide mb12 mt8
			// username']")).sendKeys("cccc");(not an ideal one)
